...
На данный момент сложность майнинга низкая, из-за чего ресурсы процессора мало используются. Тем не менее, жёсткий диск используется активно - это необходимо для синхронизации с историей блокчейна.
