...
**Proof-of-Stake** публикует m-блоки, валидированные узлами PoA. Узел PoS должен обладать значительным балансом для вноса вклада в сеть.

**Proof-of-Work** говорит сам за себя; он генерирует k-блоки, используя мощность процессора вашего ПК. Минимальный стейк не требуется. На данный момент сложность майнинга низкая, из-за чего ресурсы процессора мало используются. Тем не менее, жёсткий диск используется активно -- это необходимо для синхронизации с историей блокчейна.
