...
You can find it in [Blockchain Explorer](https://pulse.enecuum.com/) or by a direct [link]( https://pulse.enecuum.com/api/v1/ext/plain/circ_supply). Details about Enecuum Emission model are [here.](https://enecuum.com/emission-model#conversion-plan)

#### What is Enecuum's max supply?

The upper limit of all ENQ in the system is proposed to be 350,000,000 ENQ. Details [here.](https://enecuum.com/emission-model#emission-model)
